...
```{r recycling-a-logical-mask, exercise=TRUE, exercise.lines=2, exercise.setup="setup-vector-to-subset-examples"}
...
```{r equal-operator-on-vectors, exercise=TRUE, exercise.setup="equalonvectorssetup", exercise.lines=7}
