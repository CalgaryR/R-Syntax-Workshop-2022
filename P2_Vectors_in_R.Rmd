...
```{r, type-of-NAs, exercise=TRUE, exercise.length=1}
typeof(NA)
```
...
The other common case for `NA` creation happens when subsetting by a position that is out of the range of positions in the vector.
