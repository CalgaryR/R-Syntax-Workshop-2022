...
As mentioned at the end of the previous section, a common case to use lists is as arguments of vectors to create multi-dimensional objects, like matrices. Let's revisit the bakery example of the module on vectors.
