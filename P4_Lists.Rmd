...
We will cover the nature of lists, their core role in the R language, the syntax
to construct them, how to modify them, and  how to inspect them.
...
<!-- ```{r vector, echo=FALSE, warning=FALSE, results='asis'} -->
<!-- library(here) -->
...
<!-- ```{r, subsetting-matrix-from-within-matrix, exercise=T, exercise.setup="setup-subsetting-matrices", exercise.lines=2} -->
<!-- m[1:2, 3:4] -->
<!-- ``` -->
...
<!-- ```{r, 2by2by3array, exercise=TRUE, exercise.lines=4} -->
<!-- set.seed(673912) -->
...
<!-- ```{r, logical-mask-for-an-array, exercise=TRUE, exercise.lines=5} -->
<!-- (mask <- array(rep(1,12),  -->
<!--                dim = c(2,2,3), -->
<!--                dimnames = list(c(),c(),c('red','green','blue')))) -->
...
<!-- ```{r, apply-mask-on-array, exercise=TRUE, exercise.lines=2, exercise.setup="setup-for-array-mask"} -->
<!-- a * mask -->
<!-- ``` -->
...
Lists are one-dimensional vector objects that can store information of heterogeneous type, a list can even contain other lists. R's linear model object, with constructor `lm()`, is a list. Lists are very versatile and are at the center of R's model and data handling capabilities.
...
Would you have thought that R could come in handy for that party you are planning for friends and family? The list of items for the party can be nested within the list of party items, how convenient!
