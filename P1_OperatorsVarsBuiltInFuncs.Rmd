...
By the end of this tutorial, you will know the basics of R operators and operator precedence, how to create variables to hold values, and how to find and use built-in functions to get things done quickly. 
<!-- Chances are there is already a function to do what you need.  -->
Armed with this knowledge you will be able to use R at the command line or in a script file as a powerful programmable calculator and automation tool.
...
When it comes to how R stores values, let's observe the type and mode of variables.
...
```{r named-param-1, exercise = TRUE, exercise.lines=5}
(three <- log(1000, base = 10))
# un-comment to check if base exists after executing the line above
# base
# now go back and change the 'base = 10' for 'base <- 10' and re-run this box
