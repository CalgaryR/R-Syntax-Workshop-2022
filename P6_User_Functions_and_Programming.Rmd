...
```{r, calling-a-user-defined-funciton, exercise=TRUE, exercise.lines=4}
...
```{r, calling-a-user-defined-funciton-simple, exercise=TRUE, exercise.lines=4}
...
```{r, named-parameters-in-user-defined-functions, exercise=TRUE, exercise.lines=9}
...
```{r, named-parameters-in-user-defined-functions-NAs-addressed, exercise=TRUE, exercise.lines=4, exercise.setup="namedParametersInUserDefinedFunctionsNAsAddressedSetup"}
...
```{r, sapply-example-on-vector, exercise=TRUE, exercise.lines=4}
set.seed(456)
(v <- sample(1:10, 5))
...
```{r, conditionally-removing-with-filter, exercise=TRUE, exercise.lines=2}
...
```{r, conditionally-removing-with-for-loop-and-if-statement, exercise=TRUE, exercise.lines=9, exercise.setup="conditionallyRemovingWithForLoopAndIfStatementSetup"}
results <- c()
