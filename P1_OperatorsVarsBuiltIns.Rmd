...
You will absolutely need to write a custom function whenever you can't find one that meets your requirements from among the built-in functions or from those available in R packages.
...
Some reference material can be found on-line at [@DataCarpentry.org-Funcs-and-Args].
