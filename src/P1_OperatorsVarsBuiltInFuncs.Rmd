...
By the end of this tutorial, you will know the basics of R operators and operator precedence, how to create variables to hold values, and how to find and use built-in functions to get things done with R. Chances are there is already a function to do what you need. Armed with this knowledge you will be able to use R at the command line or in a script file as a powerful calculator and automation tool.

In another tutorial of this series you will learn the syntax to create your own functions. This will be fundamental to avoid repetitive code and also for when no other existing function from among the thousand of built-ins and those in publicly available R packages meets your needs.
